    ...
    return (
        <>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div
                    className="relative z-10 mb-10 h-[925px] overflow-hidden rounded-[10px] border-2 border-stroke  bg-white  py-10 px-8 shadow-pricing sm:p-12 lg:py-10 lg:px-6 xl:p-[50px]"
                >
